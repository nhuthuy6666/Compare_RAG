...
def main() -> None:
    ...
    if missing_metric_files:
        ...
        print(f"Không thể chạy reliability.py vì các file metric CSV không còn trong {results_dir}.")
        print("Mặc định evaluate-v1.py hiện chỉ giữ các file Markdown tổng hợp để folder kết quả gọn hơn.")
